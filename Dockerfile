...
RUN apt-get update && apt-get install -y mesa-opencl-icd ocl-icd-opencl-dev ntpdate gcc git bzr jq pkg-config curl \
clang build-essential hwloc libhwloc-dev wget
